                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="pseudo" type="text" class="form-control calligraf @error('pseudo') is-invalid @enderror" name="pseudo" value="{{ old('pseudo', $user->pseudo) }}" required autocomplete="pseudo" max="30">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="avatar" type="file" class="form-control @error('avatar') is-invalid @enderror" name="avatar" autocomplete="avatar" accept="image/*" max="2000">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control calligraf @error('name') is-invalid @enderror" name="name" value="{{ old('name', $user->name) }}" required autocomplete="name" max="30">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="firstname" type="text" class="form-control calligraf @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname', $user->firstname) }}" required autocomplete="firstname" max="30">
                                ...
                                <div class="form-group row">
                                    <label for="adress" class="col-md-4 col-form-label text-md-right" max="100">{{ __('Adress') }}</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="city" type="text" class="form-control calligraf @error('city') is-invalid @enderror" name="city" value="{{ old('city', $user->city) }}" required autocomplete="city" max="100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="country" type="text" class="form-control calligraf @error('country') is-invalid @enderror" name="country" value="{{ old('country', $user->country) }}" required autocomplete="country" max="100">
